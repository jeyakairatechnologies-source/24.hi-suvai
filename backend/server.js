...
app.use('/kkadmin', express.static(path.join(rootDir, 'kkadmin')));
...
// Admin Route redirect (Redirect /admin to home for security)
app.get('/admin', (req, res) => {
  res.redirect('/');
});
app.get('/kkadmin', (req, res) => {
  res.sendFile(path.join(rootDir, 'kkadmin', 'index.html'));
});
...
const startServer = async () => {
  try {
    ...
    app.listen(PORT, '0.0.0.0', () => {
      ...
      console.log(`Admin Portal    : http://localhost:${PORT}/kkadmin`);
